<template>
    <my-page title="贝塞尔曲线动画">
        <div>
            <h1>Bézier Curve<small>(点击画布设置控制点位置)</small></h1>
            <p>控制点数量：<input id="input" type=range min=3 max=7 value=5 disabled><span id="span"></span></p>
        ...
        methods: {
            init() {
                ...
                div.addEventListener('click', function(e) {
                    ...
                    var point = {x: e.pageX - box.x, y: e.pageY - box.y}
